...
<div class="lang-content" data-lang="zh" style="display:none" markdown="1">

我们是**人与智能系统课题组**，由浙江大学人工智能学院副教授**[向为](https://person.zju.edu.cn/0617496)**带领。

我们正处在一个智能系统无处不在的时代，人与 AI 的深度融合已成为不可逆转的趋势。课题组致力于解决**复杂、动态、高风险场景下的人机协同难题**——从自动驾驶、智能座舱到医疗手术——设计并应用前沿技术，实现高效、安全、以人为本的人机共生。

研究聚焦三大方向：**（1）复杂环境下的人机协同感知**，包括自动驾驶与航空领域的风险感知、认知负荷与多模态生理感知；**（2）大模型驱动的体验计算与设计**，构建模拟、预测和优化用户体验的计算模型；**（3）AI Agent 集成的智能硬件**，面向技能训练、医疗保健与康复的真实场景应用。

课题组主持国家自然科学基金、国家重点研发计划等 10 余项国家级和省部级项目，与阿里巴巴、华为、字节跳动、徐工等企业深度合作。研究成果发表于 CHI、IJCAI、IEEE T-ITS、Design Studies、IJHCS 等顶级期刊会议，授权发明专利 10 余项。
